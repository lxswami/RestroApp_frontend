...
export default function Contact() {
    return (
        ...
        >
            ...
            {/* Heading at the top */}
            <h1 className="text-center max-w-6xl text-lg md:text-[25px] font-medium mb-4 italic">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-50 max-w-6xl">
                <Slide />
                <ContactForm />
